...
export class ColorReducer {
     ...
     */
    public static createColorMap(kmeansImgData: SimpleImageData) {
     ...
     */
    public static async applyKMeansClustering(imgData: SimpleImageData, outputImgData: SimpleImageData, settings: Settings, onUpdate: ((kmeans: KMeans) => void) | null = null) {
     ...
     */
    public static updateKmeansOutputImageData(kmeans: KMeans, settings: Settings, pointsByColor: IMap<number[]>, imgData: SimpleImageData, outputImgData: SimpleImageData, restrictToSpecifiedColors: boolean) {
